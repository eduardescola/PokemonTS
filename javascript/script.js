...
function searchPokemons() {
    ...
    const suggestions = pokemonData.filter((pokemon) => pokemon.name.toLowerCase().includes(searchInput));
...
function filterPokemons() {
    var _a;
    const searchInput = document.getElementById('search').value.toLowerCase();
    const selectedType = ((_a = document.querySelector('.type-buttons .nes-btn.selected')) === null || _a === void 0 ? void 0 : _a.id) || 'all';
